...
public class Main {
  public static void main(String[] args) {
    ...
    // String
    // sol1=c.solveStage(0,Cube.stagedMoveRestrictions_2Stage,Cube.maskStages_2Stage[0]);
    // System.out.println(Cube.getAlgorithm(sol1));
    // c = Cube.execute(c,sol1);
    // String sol =
    // c.solveStage(1,Cube.stagedMoveRestrictions_2Stage,Cube.maskStages_2Stage[1]);
    // System.out.println(Cube.getAlgorithm(sol));
    // c = Cube.execute(c,sol);
    // System.out.println(c);
    // System.out.println(Cube.solveCube_2Stage(c));
    // String sol = c.solveStage(0, Cube.stagedMoveRestrictions_3Stage,
    // Cube.maskStages_3Stage[0]);
    // System.out.println(Cube.getAlgorithm(sol));
...
// gybbbgbrywyowywwywwybbooborrwygwryrgoorbrryborwgggggoo
// gybbbgbrywyowywwywwybbooborrwygwryrgoorbrryborwgggggoo
